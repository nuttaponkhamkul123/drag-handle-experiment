...
@Component({
  ...
  standalone: true,
  imports: [CdkDropList, CdkDrag, CdkDragPreview, CdkDragHandle],
})
export class CdkDragDropCustomPreviewExample implements AfterViewInit {
  @ViewChild('handle', { read: ElementRef }) handle!: ElementRef;
  @ViewChild('ccdd', { read: CdkDrag }) ccdd!: CdkDrag;
  ...
  ngAfterViewInit(): void {
    ...
    console.log('CC DD HANDLE ', this.ccdd);
    this.ccdd._dragRef.withHandles([this.handle]);
  }
}
